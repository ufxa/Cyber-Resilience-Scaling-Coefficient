...
\title{Scaling Monotonicity for Cyber Resilience: Quantifying Backdoor Persistence
       in Post-trained Large Language Models}
...
No.~x, 2026}{Costa: Scaling Monotonicity for Cyber Resilience}
...
\input{sec3_threat_model}
\input{sec4_framework}
\input{sec5_security}
