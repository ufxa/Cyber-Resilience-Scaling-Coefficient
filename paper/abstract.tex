...
persistence as a function of model scale. We establish a \emph{monotonic
scaling relationship} across three LLaMA-2 scales (7B, 13B, 70B) ---
preliminary scaling evidence that motivates but does not yet constitute
a formal scaling law.
...
on data calibrated against Yang~et~al.~\cite{yang2024watch}; see Section~VI),
AUC-ROC\,$=\,0.924$, and Pearson $r\,=\,0.847$ (72 runs across all scale-and-condition
combinations; see Section~VI for degrees-of-freedom discussion), confirming
the scaling monotonicity.
% [7] Compliance
