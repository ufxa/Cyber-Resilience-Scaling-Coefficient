...
Best per-trigger column reports the highest single-trigger value across
$\gamma_T$ (token), $\gamma_S$ (sentence), $\gamma_Y$ (style).
$\Delta$ SoTA is the improvement over the best published backdoor-detection
baseline on LLaMA-2-scale models~\cite{yang2024watch}.}
\label{tab:agent1}
