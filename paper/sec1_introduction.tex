...
\textbf{Organization.} Section~\ref{sec:background} reviews related work and
establishes notation. Section~\ref{sec:threat} formalizes the threat model and
derives CRSC. Section~\ref{sec:framework} presents the algorithmic pipeline.
Section~\ref{sec:security} addresses security compliance. Section~\ref{sec:experiments}
reports experimental results. Sections~\ref{sec:discussion} and~\ref{sec:conclusion}
