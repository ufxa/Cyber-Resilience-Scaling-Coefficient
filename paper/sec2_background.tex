...
\begin{tabular}{lcccc}
\toprule
\textbf{Method} & \textbf{Scale} & \textbf{Formal} & \textbf{LLM} & \textbf{RLHF} \\
 & \textbf{Dep.} & \textbf{Proof} & \textbf{Native} & \textbf{Aware} \\
\midrule
BES~\cite{li2022backdoor}   & \xmark & \xmark & \cmark & \xmark \\
TrojAI~\cite{trojai2024}    & \xmark & \xmark & \cmark & \xmark \\
ASR-RLHF~\cite{yang2024watch} & \xmark & \xmark & \cmark & \cmark \\
CRSC (ours)                 & \cmark & \cmark & \cmark & \cmark \\
\bottomrule
\end{tabular}
\end{table}
