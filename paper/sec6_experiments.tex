...
detection baselines whose LLaMA-2-scale results are not directly comparable
(they target image-domain or shallow NLP triggers); we include their
citations for completeness and identify their adaptation to RLHF-fine-tuned
LLMs as a priority for future empirical comparison.
